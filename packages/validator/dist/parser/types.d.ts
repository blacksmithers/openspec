...
export interface TechStackItem {
    ...
    name: string;
    version?: string;
    layer: 'database' | 'backend' | 'frontend' | 'infrastructure' | 'devops' | 'observability' | 'auth' | 'integration' | 'testing';
    rationale?: string;
...
export interface NonFunctionalRequirement {
    id: string;
    description: string;
    category: 'performance' | 'security' | 'scalability' | 'reliability' | 'availability' | 'usability' | 'maintainability' | 'observability' | 'compliance' | 'accessibility';
    metric: string;
    target: string;
...
export interface Blueprint {
    ...
    description?: string;
    slug?: string;
    category: 'flowchart' | 'architecture' | 'state' | 'sequence' | 'erd' | 'mockup' | 'adr' | 'component' | 'deployment' | 'api' | 'algorithm' | 'protocol' | 'glossary' | 'design_system';
